...
public final class Resources {
	...
	public static InputStream getResourceStream(
			final String path, final ServletContext servletContext, final Class<?> clazz) throws IOException {
		...
		if (is == null) {
			throw new IOException(String.format("unable to locate resource - %s", path));
		}
		return is;
	}
